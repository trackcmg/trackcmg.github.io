...
export function isFallbackState() {
  ...
  return noHoldings && noCash && noInvested && noClosed && noHistory && noGym && noBooks && noMovies && noSeries && !(D.games || []).length && !(D.workouts || []).length && !(D.watchlist || []).length && !D.trainingInitialized;
}
